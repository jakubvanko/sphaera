...
import { URL_CART, URL_LOGIN, URL_TICKETS } from "../../scripts/constants/urls";
import { FormStatus } from "../../components/FormBase";
import { LinkBasic } from "../../components/TextType/TextType.styled";
        ...
        <EmptyTextContainer>
          <TextBig>
            ...
            <LinkBasic as={Link} to={URL_TICKETS}>
              check out some of our latest shows.
            </LinkBasic>
          </TextBig>
        </EmptyTextContainer>
      ) : (
        <ItemContainer>
          ...
          <ContainerBordered>
            <PolicyInformationContainer>
              ...
              Sphaera tickets and additional goods associated with the
              advertised events.
