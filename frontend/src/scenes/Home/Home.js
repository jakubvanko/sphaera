...
const Home = () => {
  ...
  return (
    <Container>
      ...
      <BlackBanner>
        <BannerText>
          Spheara is committed to promote inclusivity, passion, friendliness and
          a shared sense of belonging through art and music. We support artists
          and musicians whose mission is to empower people to be the best
          versions of themselves.
        </BannerText>
      </BlackBanner>
      <IconContainer>
        <IconText>Sphaera is proud to house these amazing groups:</IconText>
      ...
      <CorporateContainer>
        <MainText href={"#"}>
          Sphaera is forever grateful to its family of{" "}
          <CorporateLink>Corporate Partners</CorporateLink> for their support.
        </MainText>
      </CorporateContainer>
    </Container>
  );
